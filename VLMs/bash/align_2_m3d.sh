...
deepspeed --num_gpus=1 --master_port=29501 llava/train/train_mem.py \
    ...
    --type CT \
    --data_path /workdir/radish/PET-CT/PET-CT-report/pretrain_data/single_turn/petct/ct/align_train.json \
    --eval_data_path /workdir/radish/PET-CT/PET-CT-report/pretrain_data/single_turn/petct/ct/align_val.json \
    ...
    --bf16 True \
    --output_dir /workdir/radish/PET-CT/ctvit_m3d/checkpoints/ct/align \
    --num_train_epochs 5 \
