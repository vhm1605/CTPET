...
deepspeed --num_gpus=1 --master_port=29510 llava/train/test.py \
    ...
    --pretrain_mm_mlp_adapter /workdir/radish/PET-CT/ctvit_llavamed/checkpoints/lora_2loss_conv/checkpoint-5572/mm_projector.bin \
    --lora_path /workdir/radish/PET-CT/ctvit_llavamed/checkpoints/lora_2loss_conv/checkpoint-5572 \
    ...
    --bf16 True \
    --output_dir /workdir/radish/PET-CT/ctvit_llavamed/infer/lora_2loss_conv/checkpoint-5572/test \
    --num_train_epochs 10 \
