...
deepspeed --num_gpus=1 --master_port=29511 llava/train/test.py \
    ...
    --pretrain_mm_mlp_adapter /workdir/radish/PET-CT/ctvit_m3d/checkpoints/lora_instruct_fix/checkpoint-13930/mm_projector.bin \
    --lora_path /workdir/radish/PET-CT/ctvit_m3d/checkpoints/lora_instruct_fix/checkpoint-13930 \
    --question_file /workdir/radish/PET-CT/PET-CT-report/pretrain_data/single_turn/align_test_petct_instruction_ctvit_m3d_fix.json \
    --temperature 0.5 \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir /workdir/radish/PET-CT/ctvit_m3d/checkpoints/infer_instruct_fix/test \
    --num_train_epochs 10 \
