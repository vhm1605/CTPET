...
deepspeed llava/train/train_mem.py \
    ...
    --pretrained_lora_path /home/jovyan/shared/tienhuu060102/data-petct/shared_codes/ViReportGen/VLMs/checkpoints/ctvit_llavamed_lora/checkpoint-2778 \
    --tune_mm_mlp_adapter True \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ./checkpoints/petct/ctvit_llavamed_lora_phase2 \
    --num_train_epochs 5 \
