...
deepspeed --num_gpus=1 --master_port=29503 llava/train/train_mem.py \
    ...
    --type PET/CT \
    --data_path /workdir/radish/PET-CT/PET-CT-report/pretrain_data/single_turn/align_train_petct_instruction_ctvit_m3d_fix.json \
    --eval_data_path /workdir/radish/PET-CT/PET-CT-report/pretrain_data/single_turn/align_val_petct_instruction_ctvit_m3d_fix.json \
    ...
    --pretrained_lora_path /workdir/radish/PET-CT/ctvit_m3d/checkpoints/lora/checkpoint-8331 \
    --tune_mm_mlp_adapter True \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir /workdir/radish/PET-CT/ctvit_m3d/checkpoints/lora_instruct_fix \
    --num_train_epochs 10 \
