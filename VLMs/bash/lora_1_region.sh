...
deepspeed --num_gpus=1 --master_port=29503 llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /workdir/radish/PET-CT/ctvit_llavamed/checkpoints/align_region2/checkpoint-2786/mm_projector.bin \
    --tune_mm_mlp_adapter True \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir /workdir/radish/PET-CT/ctvit_llavamed/checkpoints/lora_region_minh2 \
    --num_train_epochs 20 \
