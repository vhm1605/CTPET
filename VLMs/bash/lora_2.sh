...
deepspeed llava/train/train_mem.py \
    ...
    --type CT \
    --data_path /home/jovyan/shared/tienhuu060102/data-petct/PET_report_paired_fixed/instruction/petct/ct/instruction_train_data.json \
    --eval_data_path /home/jovyan/shared/tienhuu060102/data-petct/PET_report_paired_fixed/instruction/petct/ct/instruction_val_data.json \
    ...
    --pretrain_mm_mlp_adapter /home/jovyan/shared/tienhuu060102/data-petct/shared_codes/ViReportGen/VLMs/checkpoints/ct/ctvit_llavamed_align/checkpoint-2788/mm_projector.bin \
    --tune_mm_mlp_adapter True \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ./checkpoints/ct/ctvit_llavamed_lora \
    --num_train_epochs 20 \
